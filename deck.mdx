...
<img src="./images/avater.jpg" alt="たくもんのアイコン" style={{
  borderRadius: '50%',
  width: '13rem',
  height: '13rem',
  margin: '1rem',
...
<img src="./images/mdx-deck-logo.png" style={{maxHeight:'60vh', maxWidth: '60vw',  objectFit: 'contain'}}/>
...
![images/mdx-deck-background.png](./images/mdx-deck-background.png)
...
* よく使う部品やアニメーションをコンポーネント化して再利用できる
...
<img src="./images/code-surfer-logo.png" style={{maxHeight:'60vh', maxWidth: '60vw',  objectFit: 'contain'}}/>
...
* 大量のコードでもズーム＆スクロールなどのアニメーションができる
* アニメーションごとに説明文が設定できる
